    ...
    <div className="ml-5 mt-5">
      ...
      <div className="flex flex-col lg:flex-row lg:space-x-4">
        <div className="w-full lg:w-[900px] h-auto lg:h-screen border border-blue-300 rounded-t-lg">
          ...
          {/* Text */}
          <div className="mt-10">
            <p className="text-xl font-bold text-center">Ready to add content?</p>
            <p className="text-sm text-center py-10">
              There are two ways to add content to your project - choose the most suitable option for you.
            </p>
          </div>
          {/* File upload */}
                  ...
                  <Link href={'/developerDashboard/uploadFile'}>
                    <div className="relative w-full h-60 rounded-2xl border-dashed border-2 border-blue-700 bg-gray-100 flex justify-center items-center">
                      <div className="absolute w-full px-5">
                        <h1 className="text-md font-medium leading-loose mb-2 text-center">File Upload</h1>
                        ...
                        <div className="flex flex-col items-center">
                          ...
                          <p className="text-xl py-2 text-blue-700">Select a File Upload</p>
                          <span className="block text-sm text-gray-400 font-normal">Or Drag and Drop It here</span>
                        </div>
                      </div>
              ...
              <div className="rounded-lg overflow-hidden">
                <div className="flex justify-center">
                  <Link href={'/developerDashboard/addManualKey'}>
                    <div className="relative w-full h-60 rounded-2xl border-dashed border-2 border-blue-700 bg-gray-100 flex justify-center items-center">
                      <div className="absolute w-full px-5">
                        <h1 className="text-md font-medium leading-loose mb-2 text-center">Add keys manually</h1>
                        <hr className="w-full mb-3" />
                        <div className="flex flex-col items-center">
                          <svg
                            width="64"
                          ...
                          >
                            ...
                            <p className="text-xl py-2 text-blue-700">Add keys and Value</p>
                            <span className="block text-sm text-gray-400 font-normal">Or Drag and Drop It here</span>
                        </div>
                      </div>
                      <input type="file" className="h-full w-full opacity-0 cursor-pointer" />
