    ...
    return (
        <div className="w-full">
            ...
            {isDeleteModalVisible && (
                ...
                >
                    <div className="bg-white flex flex-col p-5 gap-2 justify-center items-center text-center rounded-lg shadow-lg">
                        <DeleteOutlineOutlinedIcon
                            sx={{ color: red[400], fontSize: 50 }}
                        />
                        ...
                        <div className="flex gap-4 pt-2">
                            ...
                            <button
                                className="px-4 py-2 bg-red-500 text-white rounded-md text-sm hover:bg-red-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150 ease-in-out "
                            ...
                            <div className="flex flex-col w-full lg:w-auto py-2 lg:mt-0 text-xs">
                                ...
                                {editUser.status === "Pending" ? (
                                    ...
                                    <input
                                        ...
                                        value={editUser.language}
                                        readOnly
                                        className="block text-xs px-3 text-gray-500 transition duration-75 border py-1 border-gray-300 rounded-lg shadow-sm h-[41px] focus:border-blue-600 focus:ring-1 focus:ring-inset focus:ring-blue-600 mt-1 bg-none"
                                    />
                                )}
                            </div>
                    ...
                    <tbody>
                        {data.map((item, index) => (
                            ...
                            >
                                ...
                                <td
                                    className={`px-6 py-4 ${item.status === "Pending"
                                        ? "text-red-600"
