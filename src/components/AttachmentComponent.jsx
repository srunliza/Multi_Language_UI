...
const AttachmentComponent = () => {
    ...
    return (
        <div className="w-full p-6">
            {/* Table */}
            <div className="relative h-screen overflow-x-auto w-full shadow-md rounded-lg no-scrollbar">
                <table className="min-w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
                    ...
                    <tbody className="overflow-y-auto no-scrollbar">
                        {data.map((item) => (
                            <tr key={item.productName} className="bg-white border-b text-gray-900 dark:border-gray-300">
