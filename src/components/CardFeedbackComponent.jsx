const CardFeedbackComponent = () => {
    return (
            <div className="w-[486px] h-[650px] shadow-md  bg-white border border-gray-200 rounded-lg  sm:p-8 dark:bg-gray-800 dark:border-gray-700">
                <div className="flex items-center justify-between mb-4">
                    <h5 className="text-xl font-bold leading-none text-gray-900 dark:text-white">Feedback</h5>
