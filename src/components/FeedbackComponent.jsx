...
const FeedbackComponent = ({ feedback, attachmentId, userId }) => {
          ...
          {feedbacks.map((feedback, index) => (
            ...
            >
              <div className="flex items-center justify-between pb-2">
                ...
                {userId === feedback.commentBy.userId && (
                  <div className="relative">
                    <div onClick={() => togglePopup(index)}>
                      <DropdownMenu
                        ...
                        onEditClick={() =>
                          handleEditClick(feedback.feedbackId, feedback.comment)
                        }
                      />
                    </div>
              ...
              <div className="relative mt-3.5 text-gray-700 text-sm md:mt-[10px] ml-0 lg:text-md line-clamp-6 xl:w-[22rem] lg:w-[10rem] sm:w-[30rem] sm:pt-3 lg:mt-1 xl:mt-1 break-words">
                {feedback.comment}
              </div>
              <div className="text-gray-500 sm:text-xs md:text-xs lg:text-xs mt-2 ml-0">
