        ...
        <main>
            <div className="bg-white py-3 px-5 shadow-md rounded-xl min-h-[100px]">
                        ...
                        <div className='overflow-auto max-h-[420px] mb-4 no-scrollbar'>
                            ...
                            {/* item 1 */}
                            <div className="bg-white shadow px-2 rounded-xl mb-2.5">
                                <div className="flex py-2 pb-2">
                                    ...
                                    <span className='text-gray-800 flex justify-end ml-[237px]'><MoreVertIcon/></span>
                                        <div className="font-medium text-gray-800 mt-[-20px]">Kroem Vandy</div>
                                        <div className="text-gray-600 text-xs mt-1">Developer</div>
                                        <div className="mt-3 text-gray-700 text-[13px] ml-[-63px]">Dear translator, you have some mistake in your translatationn please edit it as soon as possible</div>
                                        <div className='text-gray-500 text-sm mt-2 ml-[-63px]'>20 May 2024</div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="bg-white shadow px-2 rounded-xl mb-2.5">
                                <div className="flex py-2 pb-2">
                                    ...
                                    <div className="ml-3 text-p">
                                    <span className='text-gray-800 flex justify-end ml-[237px]'><MoreVertIcon/></span>
                                        <div className="font-medium text-gray-800 mt-[-20px]">Srun Liza</div>
                                        <div className="text-gray-600 text-xs mt-1">Developer</div>
                                        <div className="mt-3 text-gray-700 text-[13px] ml-[-63px]">Dear translator, you have some mistake in your translatationn please edit it as soon as possible</div>
                                        <div className='text-gray-500 text-sm mt-2 ml-[-63px]'>20 May 2024</div>
                                    </div>
                            ...
                            <div className="bg-white shadow px-2 rounded-xl mb-2.5">
                                <div className="flex py-2 pb-2">
                                    ...
                                    <div className="ml-3 text-p">
                                     <span className='text-gray-800 flex justify-end ml-[237px]'><MoreVertIcon/></span>
                                        <div className="font-medium text-gray-800 mt-[-20px]">Tep Thean</div>
                                        <div className="text-gray-600 text-xs mt-1">Developer</div>
                                        <div className="mt-3 text-gray-700 text-[13px] ml-[-63px]">Dear translator, you have some mistake in your translatationn please edit it as soon as possible</div>
                                        <div className='text-gray-500 text-sm mt-2 ml-[-63px]'>20 May 2024</div>
                                    </div>
