                        ...
                        <div>
                            <div className="grid grid-cols-2 gap-4">
                                <div>
                                    ...
                                    <input type="text" id="first_name" placeholder="Enter first name" className="border-blue-200 border-2 w-full rounded-lg py-2 px-3 focus:ring-blue-500 focus:border-blue-500 block p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" />
                                </div>
                                <div>
                                    <label htmlFor="last_name" className="block text-gray-700 dark:text-white mb-1">Last Name</label>
                                    <input type="text" id="last_name" placeholder="Enter last name" className="border-blue-200 border-2 w-full focus:ring-blue-50 rounded-lg py-2 px-3" />
                                </div>
                            </div>
                            {/* Gender */}
                            <div className="grid grid-cols-2  pt-4">
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" id="gender_male" className="text-gray-900 text-sm rounded-s-lg focus:ring-blue-500 focus:border-blue-500 w-full pl-10 p-2.5 border-blue-200 border-2 dark:bg-gray-700 dark:border-blue-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Male" />
                                    </div>
                                </div>
                                <div>
                                    ...
                                    <div className="relative">
                                        ...
                                        <input type="text" id="gender_male" className="text-gray-900 text-sm rounded-e-lg focus:ring-blue-500 focus:border-blue-500 block w-full pl-10 p-2.5 border-blue-200 border-2 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Male" />
                                    </div>
                                </div>
                            </div>
                            {/* Date of Birth */}
