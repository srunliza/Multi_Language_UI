            ...
            <div className="flex items-center justify-between p-3 bg-white border-b border-gray-200 overflow-auto  no-scrollbar">
                <div className="flex items-center px-4">
                    ...
                    <div className="relative hidden md:block  md:mx-20 mx-20 ">
                        ...
                        <input type="text" id="search-navbar" className="mx-4 w-[500px] p-2 pl-10 text-gray-800 text-sm bg-gray-50 border-blue-300 border-2 rounded-md px-4 py-3" placeholder="Search Project" />
                    </div>
                </div>
