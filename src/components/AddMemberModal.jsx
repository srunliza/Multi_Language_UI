                    ...
                    <div className="flex items-center justify-center min-h-screen">
                        ...
                        <div className="relative z-20 bg-white w-full max-w-sm p-6 rounded-lg shadow-lg">
                            ...
                            <form action="" method="post">
                                ...
                                <div className="py-4">
                                    <label htmlFor="select" className="block mb-2 text-lg font-medium text-gray-700">
                                        Assign role
                                    </label>
                                    <select className="block w-full text-sm text-gray-500 transition duration-75 border p-2 outline-0 border-gray-300 rounded-lg shadow-sm focus:border-blue-600 focus:ring-1 focus:ring-inset focus:ring-blue-600 mt-1 bg-white">
