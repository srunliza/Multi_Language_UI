      ...
      <div className="grid grid-cols-12 gap-8">
        <div className="col-span-8">
                ...
                <tbody>
                  {translateData.map((e) => (
                    <tr key={e.id} className="grid grid-cols-2">
                      <td className="w-full p-2 border border-gray-300 rounded ">
                        {e.baseLang}
                      </td>
                      <td>
                        <input
          ...
          <div className="flex gap-4 mt-4 justify-end">
            ...
            <button
              className="btntext-white bg-blue-700 text-center rounded-lg text-sm py-2 px-3 w-[100px] text-white"
              ...
              <div className="modal-box">
                ...
                <div className="modal-action ">
                  <form method="dialog " className="flex m-auto gap-5">
                    ...
                    <button className="btn btn-outline btn-primary w-[100px]">
                      No
                    </button>
                    <button className="btn btn-active btn-primary w-[100px]">
                      Yes
                    </button>
                  </form>
                </div>
            ...
            <button
              className="btntext-white bg-green-600 text-center rounded-lg text-sm py-2 px-3 w-[100px] text-white"
              onClick={() => document.getElementById("my_modal_1").showModal()}
            >
              Submit
            </button>
