...
const SidebarComponent = () => {
    return (
        <div class="flex h-screen bg-gray-100">
            ...
            {/* <!-- sidebar --> */}
            <div class="hidden md:flex flex-col w-64 bg-blue-800 fixed">
                ...
                <div className="flex flex-col flex-1 ">
                        <nav className="flex-1 px-2 block m-auto">
                            ...
                            <Link href="/calendar" className="flex items-center px-4 py-2 mt-2 text-gray-100 gap-2 pt-10 font-light-[16px]">
                                <img src="./schedule_icon.svg" alt="calendar" />
                              <b>Calender</b>
                            </Link>
