        ...
        <table className="min-w-full text-sm text-left rtl:text-right text-gray-500 dark:text-gray-400">
          <thead className="text-sm text-gray-700 font-semibold sticky top-0 bg-[#daeaff]">
            <tr>
              ...
              <th
                scope="col"
                className="px-1 py-4 text-right flex justify-center items-center pr-3"
              >
                Action
              </th>
            </tr>
              ...
              >
                ...
                <td className="flex gap-2 justify-center">
                  <div className="dropdown">
                    ...
                    <ul
                      tabIndex={0}
                      className="dropdown-content z-[1] menu p-2 shadow bg-base-100 rounded-box w-[8rem]"
                    >
                      <li>
                        <a className="text-red-500 font-semibold">XML File</a>
                      </li>
                      <li>
                        <a className="text-yellow-500 font-semibold">
                          JSON File
                        </a>
                      </li>
                      <li>
