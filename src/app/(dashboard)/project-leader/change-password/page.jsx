...
const ChangePassword = () => {
    ...
    const handlePasswordChange = (e) => {
        ...
        if (!value) {
            ...
            setPasswordError('Confirm password does not match. Enter new password again here.');
        } else {
            setPasswordError('');
        }
    };
     ...
     const handleNewPasswordChange = (e) => {
        ...
        if (!value) {
            ...
            setNewPasswordError("Choose a more secure password you don't use anywhere else.It should be at lest 6 characters and difficult for other to guess.");
        } else {
            setNewPasswordError('');
        }
    };
            ...
            <form className="w-full p-10" onSubmit={handleSubmit}>
                <div className="bg-white  p-8 h-auto rounded-lg shadow-md border dark:border-gray-700 max-w-screen-lg mx-auto">
                    ...
                    <div className='flex gap-5 '>
                        <a href="/developer/setting">User Info</a>
                        <a href="/developer/change-password" className="text-blue-500">Change Password</a>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-1">
                        ...
                        <div className=" sm:p-7 container ">
                            ...
                            <div className="grid gap-y-4 mt-5">
                                <div>
                                    <label htmlFor="password" className="block font-medium text-gray-700 mb-2 sm:text-sm md:text-base  lg:text-base">Current Password</label>
                                ...
                                {/* New Password */}
                                <div>
                                    <label htmlFor="password" className="block font-medium text-gray-700 mb-2 sm:text-sm md:text-base  lg:text-base">New Password</label>
                                    <div className="relative">
                                    <input
                                            id="password"
                                            type={newPasswordVisible ? "text" : "password"}
                                            className={`text-gray-700 pl-5 focus:ring-gray-500 focus:border-gray-500 sm:text-sm sm:leading-6 rounded-md border py-2 pr-20 focus:outline-none input input-bordered w-full ${newPasswordError ? 'border-red-500' : ''}`}
                                ...
                                {/* Confirm Password */}
                                <div>
                                    <label htmlFor="password" className="block font-medium text-gray-700 mb-2 sm:text-sm md:text-base  lg:text-base">Confirm Password</label>
                                    <div className="relative">
                                        <input
                                            id="password"
                                            type={passwordVisible ? "text" : "password"}
                                            className={`text-gray-700 pl-5 focus:ring-gray-500 focus:border-gray-500 sm:text-sm sm:leading-6 rounded-md border py-2 pr-20 focus:outline-none input input-bordered w-full ${passwordError ? 'border-red-500' : ''}`}
