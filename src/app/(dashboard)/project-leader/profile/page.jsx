...
const ProfilePage = () => {
  return (
    <main className="mx-16">
      <div className="bg-white w-full pl-32 rounded-xl shadow-slate-300 py-10">
      ...
      <div className="bg-white w-full pl-32 mt-4 border-gray-400 rounded-xl shadow-md py-10">
