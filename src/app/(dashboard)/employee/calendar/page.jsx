...
const CalendarPage = () => {
  return (
    <main className="flex items-center justify-center ">
      <div className="w-full container  p-4 bg-white shadow-md rounded-lg">
        ...
        <div className="grid grid-cols-7 text-gray-800 bg-[#f1f4f9] rounded-lg">
          ...
          <div className="p-5 text-right pt-2 pb-12 bg-opacity-25 bg-custom-pattern bg-custom-size border">
            25
          </div>
          <div className="p-8 text-right pt-2 pb-12 bg-opacity-25 bg-custom-pattern bg-custom-size bg-gray-100 border">
            26
          </div>
          <div className="p-8 text-right pt-2 pb-12 bg-opacity-25 bg-custom-pattern bg-custom-size bg-gray-100 border">
            27
          ...
          <div className="p-8 text-right pt-2 pb-12 pr-4 bg-white border">
            1
          </div>
          ...
          <div className="p-8 text-right pt-2 pb-12 pr-4 bg-white border relative">
            3
            <div className="absolute bottom-0 left-0 right-0 bg-blue-100 border-l-4 border-blue-500 text-blue-600 text-xs p-1">
              Start Date
            </div>
          </div>
          <div className="p-8 text-right pt-2 pb-12 pr-5 bg-white border">
            4
          </div>
          <div className="p-8 text-right pt-2 pb-12 pr-5 bg-white border">
            5
          ...
          <div className="p-8 text-right pt-2 pb-12 pr-5 bg-white border relative">
            16
            <div className="absolute bottom-0 left-0 right-0 bg-pink-100 text-pink-600 border-l-4 border-pink-500 text-xs p-1">
              End Date
            </div>
          </div>
          <div className="p-8 text-right pt-2 pb-12 pr-5 bg-white border">
          ...
          <div className="p-8 text-right pt-2 pb-12 pr-5 bg-white border relative">
            27
            <div className="absolute bottom-0 left-0 right-0 bg-orange-100 text-orange-600 border-l-4 border-red-500 text-xs p-1">
              End Date
            </div>
          </div>
          <div className="p-8 text-right pt-2 pb-12 pr-5 bg-white border">
          ...
          <div className="p-8 text-right pt-2 pb-12 pr-5 bg-opacity-25 bg-custom-pattern bg-custom-size bg-gray-100 border">
            30
          </div>
          <div className="p-8 text-right pt-2 pb-12 pr-5 bg-opacity-25 bg-custom-pattern bg-custom-size bg-gray-100 border">
            31
