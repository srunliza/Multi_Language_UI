      ...
      <form className="w-full p-10" onSubmit={handleSubmit}>
        <div className="bg-white p-8 h-auto rounded-lg shadow-md border dark:border-gray-700 max-w-screen-lg mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2">
            ...
            <div>
              <div className="grid grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    className={`text-gray-700focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 rounded-md border py-1.5 pr-20 pl-3 input-primary w-full max-w-xs ${
              ...
              <div className="grid grid-cols-2 pt-2">
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      className={`text-gray-700focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 rounded-s-md border py-1.5 pr-20  input-primary w-full max-w-xs ${
                        selectedGender === "male"
                          ? "bg-gray-200"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      type="button"
                      className={`text-gray-700focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 rounded-e-md border py-1.5 pr-20  input-primary w-full max-w-xs ${
                        selectedGender === "female"
                          ? "bg-gray-200"
                          : selectedGender === "female"
                          ? "bg-white"
              ...
              <div className="mt-2">
                ...
                <DatePicker label="Birth date" className="max-w-[284px] h-[50px]" />
              ...
              <div className="mt-2">
                ...
                <div className="relative text-gray-800 ">
                  <Input
                    type="email"
                    id="email"
                    className={`text-gray-700focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6 rounded-md border py-1.5 pr-20 pl-10 input-primary w-full ${
          ...
          <div className="mt-3 flex sm:ml-12 md:ml-12 justify-end gap-3 mr-10">
            <button
              type="button"
              className="bg-red-500 text-white px-4 py-2 rounded-lg hover:bg-red-600 dark:bg-teal-600 dark:text-white dark:hover:bg-teal-900 w-[100px]"
            >
              Cancel
            </button>
            <button
