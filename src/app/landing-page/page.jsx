...
const LandingPageComponent = () => {
  return (
    <div className="bg-[#F5F5F5]">
      ...
      {/*Teammember */}
      <div>
      <h2 className="text-3xl font-bold text-[#454545] mb-4 ml-10 text-left">Meet Our Team</h2>
          <div id="default-carousel" class="rounded-lg overflow-hidden" data-carousel="static">
              ...
              <img src="../Images/Point.png" alt="" className="mx-auto w-12 py-2 " />
          </div>
      </div>
        ...
        <div className="flex flex-col md:flex-row justify-evenly items-center">
          ...
          <div className="mt-12 md:mt-0">
            <div className=" md:mb-0">
              <img src="../Images/contact.png" alt="contact" className="w-1/2 md:w-9/12" />
            </div>
          </div>
        </div>
      </section>
