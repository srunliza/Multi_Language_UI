    ...
    <main className="bg-[url('/assets/images/background.jpg')] bg-cover bg-center w-full min-h-screen flex justify-center">
      <div className='flex justify-center items-center'>
        ...
        <div className="bg-white rounded-2xl mt-10 shadow-lg p-8 sm:p-10 md:px-14 md:py-8 max-w-md w-full">
          ...
          <p className="text-gray-600 sm:text-xs md:text-sm lg:text-[15px] mb-5">Enter your details to create an account</p>
          ...
          <form onSubmit={handleSubmit}>
            ...
            {/* input first name */}
            <div className="mb-3">
              <label htmlFor="first-name" className="block font-medium text-gray-700 mb-2 sm:text-sm md:text-sm lg:text-[15px]">First Name</label>
            ...
            {/* input last name */}
            <div className="mb-3">
              <label htmlFor="last-name" className="block font-medium text-gray-700 mb-2 sm:text-sm md:text-sm lg:text-[15px]">Last Name</label>
              <div className="relative">
                <input 
                type="text" 
                id="last-name" 
            ...
            <div className="grid grid-cols-1 gap-6 md:grid-cols-2 mb-3">
              ...
              <div className="flex flex-col">
                <label htmlFor="gender" className="text-gray-700 font-medium mb-1 sm:text-sm md:text-sm lg:text-[15px]">Gender</label>
                <div className="relative">
                  <select
                    id="gender"
                    className="block appearance-none w-full bg-white border border-blue-600 text-gray-700 py-2.5 text-sm px-4 rounded-lg leading-tight focus:outline-none focus:ring-2 focus:ring-blue-400"
                    value={gender}
              ...
              {/* Date of Birth Input */}
              <div className="flex flex-col">
                <label htmlFor="dob" className="text-gray-700 font-medium mb-1 sm:text-sm md:text-sm lg:text-[15px]">Date of birth</label>
                <div className="relative">
                  <input
                    type="date"
                    id="dob"
